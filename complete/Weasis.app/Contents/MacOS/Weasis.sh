...
curPath2=$(dirname "$(dirname "$(dirname "$(dirname "$0")")")")
cps="$curPath2/weasis/weasis-launcher.jar:$curPath2/weasis/felix.jar:$curPath2/weasis/substance.jar"
# Launch
$JAVACMD $DEFAULT_JVM_OPTIONS"$GOSH_ARGS" -Dweasis.portable.dir="$curPath2" -classpath "$cps" org.weasis.launcher.WeasisLauncher \$dicom:get --portable ${userParameters[@]}
